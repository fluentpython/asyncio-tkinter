...
class Application(tk.Frame):
    def __init__(self, master=None):
        ...
        self.QUIT = tk.Button(self, text="QUIT", fg="red", font='Consolas 18', command=self.my_quit)
    ...
    def my_quit(self):
        root.destroy() # hangs after closing window
        #sys.exit() # hangs before closing window
        #app.quit() # hangs before closing window
        #self.quit() # hangs before closing window
